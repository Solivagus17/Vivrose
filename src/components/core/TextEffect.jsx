...
export function TextEffect({
  ...
  const effectivePer = isString ? per : 'word';
  ...
  const stagger = defaultStaggerTimes[effectivePer] / speedReveal;
    ...
    <AnimatePresence mode="popLayout">
      {trigger && (
        <MotionTag
          ...
          style={style}
        >
          {effectivePer !== 'line' ? <span className="sr-only">{children}</span> : null}
