        ...
        <div className="report-page">
          <div className="report-header">
            <div className="report-logo">
              <div className="r-mark">S</div>
              <div>
                <div className="r-text">ShushrutAI</div>
            ...
            <div className="report-date">
              ...
              <div style={{ marginTop: 4 }}>Report ID: SH-HR-{(member?.assessed || '').replace(/\s|,/g, '').slice(0, 8)}-{(member?.id || 'MEM').toUpperCase()}</div>
            </div>
          </div>
          ...
          <div className="report-footer">
            <p>
              This report was generated by the ShushrutAI health assessment.
              <br />
              All findings are AI-assisted and should be discussed with a qualified healthcare professional.
              <br />
              ShushrutAI · Predict. Prevent. Prosper. · © 2026
            </p>
          </div>
        </div>
      </div>
